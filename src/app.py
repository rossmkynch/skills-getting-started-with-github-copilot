...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice shooting, passing, and game strategy",
    ...
    "Drama Club": {
        "description": "Act, perform, and create stage productions with peers",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore STEM projects",
